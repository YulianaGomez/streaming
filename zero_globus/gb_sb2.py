...
def transfer(sp,destination_endpoint_id,one_endpoint):
    ...
    tdata = globus_sdk.TransferData(tc, source_endpoint_id, destination_endpoint_id,label="nogrowcheckplease", perf_cc=3, sync_level=None, verify_checksum=False)
...
def main():
  ...
  transfer('/dev/zero', destination_ep, False) #from yulie7t
