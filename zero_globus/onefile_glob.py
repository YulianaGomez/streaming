...
src_path_all = '/home/cc/streaming/zero_globus/test_files' # chameleon
#src_path_all = '/home/parallels/stream_transfer/zero_globus/test_files' #linux
...
def multi_transfer():
    ...
    #for ifile in files:
    while ep_count < 3:
        gl_refresh_chameleon.transfer(src_path_all,ep00)
        time.sleep(200)
        ep_count += 1
